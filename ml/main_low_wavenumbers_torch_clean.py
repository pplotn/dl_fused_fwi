...
path_test2=fnmatch.filter(path_test,'*Overthrust*')
path_test=path_test2.copy()
...
# sample_models3(test_dataloader,generator,opt,opt.n_epochs,flag_show_scaled_data=0)
sample_dataset(test_dataloader,generator,opt,opt.n_epochs,flag_show_scaled_data=1,data_mode='test',record_weights=0)
# sample_dataset_specially(generator,opt,opt.n_epochs,flag_show_scaled_data=0)
exit()
